...
/**
 * QGradeType2TableEntity is a Querydsl query type for GradeType2TableEntity
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QGradeType2TableEntity extends EntityPathBase<GradeType2TableEntity> {

    private static final long serialVersionUID = -810075299L;

    public static final QGradeType2TableEntity gradeType2TableEntity = new QGradeType2TableEntity("gradeType2TableEntity");
    ...
    public final NumberPath<Integer> OrderPercentage = createNumber("OrderPercentage", Integer.class);
    ...
    public QGradeType2TableEntity(String variable) {
        super(GradeType2TableEntity.class, forVariable(variable));
    }

    public QGradeType2TableEntity(Path<? extends GradeType2TableEntity> path) {
        super(path.getType(), path.getMetadata());
    }

    public QGradeType2TableEntity(PathMetadata metadata) {
        super(GradeType2TableEntity.class, metadata);
    }
